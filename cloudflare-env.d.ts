/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv .\cloudflare-env.d.ts` (hash: ceabee7e3a9933ef3b11f06ec7bd7902)
// Runtime types generated with workerd@1.20260918.1 2026-09-19 nodejs_compat
interface __BaseEnv_CloudflareEnv {
	MEMBER_MEDIA: R2Bucket;
	DB: D1Database;
	ASSETS: Fetcher;
	APP_ENV: "staging" | "production";
	APP_URL: "https://nami-creative-site-staging.workers.dev" | "https://namicreative.co.uk";
	OWNER_EMAIL: "hello@namicreative.co.uk";
	MEMBER_MEDIA_BASE_URL: "https://media.namicreative.co.uk";
	MAILCHIMP_API_KEY: string;
	MAILCHIMP_AUDIENCE_ID: string;
	CONTACT_WEBHOOK_URL: string;
	NEXT_PUBLIC_GA_ID: string;
	CREATIVE_NETWORK_WEBHOOK_URL: string;
	PROFILE_IMAGE_WEBHOOK_URL: string;
	DIRECTORY_FEED_WEBHOOK_URL: string;
...
declare namespace Cloudflare {
	interface StagingEnv {
		...
		ASSETS: Fetcher;
		APP_ENV: "staging";
		APP_URL: "https://nami-creative-site-staging.workers.dev";
		OWNER_EMAIL: "hello@namicreative.co.uk";
		MEMBER_MEDIA_BASE_URL: "https://media.namicreative.co.uk";
		MAILCHIMP_API_KEY: string;
		MAILCHIMP_AUDIENCE_ID: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_ENV" | "APP_URL" | "OWNER_EMAIL" | "MEMBER_MEDIA_BASE_URL" | "MAILCHIMP_API_KEY" | "MAILCHIMP_AUDIENCE_ID" | "CONTACT_WEBHOOK_URL" | "NEXT_PUBLIC_GA_ID" | "CREATIVE_NETWORK_WEBHOOK_URL" | "PROFILE_IMAGE_WEBHOOK_URL" | "DIRECTORY_FEED_WEBHOOK_URL" | "MAKE_API_TOKEN" | "MAILCHIMP_SERVER_PREFIX">> {}
}

...
export default async function NetworkEventsPage(){
 ...
 return <main className="relative min-h-screen overflow-hidden pb-24 pt-24">
  ...
  <div className="container-shell relative z-10">
   ...
   <section id="upcoming" className="scroll-mt-24 pt-24"><div className="flex items-end justify-between gap-4"><div><p className="text-xs font-bold uppercase tracking-[.15em] text-accent">The calendar</p><h2 className="mt-2 text-3xl md:text-5xl">Coming up</h2></div><CalendarDays className="text-accent" size={28}/></div>

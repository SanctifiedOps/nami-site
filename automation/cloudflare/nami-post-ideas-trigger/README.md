...
Make must reject a duplicate `runId` before research or email delivery. That provides the final guard against Cloudflare retries or accidental manual reruns.
